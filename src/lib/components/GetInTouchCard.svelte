...
<a
	{href}
	class="group bg-tertiary-bg text-primary-text relative h-24 w-full max-w-2xl rounded-3xl text-base font-medium transition-all duration-300 xl:h-52 xl:text-lg"
>
