...
{#if $showBtn}
	<button
		bind:this={btn}
		onclick={scrollToTop}
		class="group bg-tertiary-bg fixed right-10 bottom-10 z-50 hidden cursor-pointer items-center rounded-full px-1 py-1 transition-all duration-500 ease-in-out lg:flex"
	>
		<div
