...
<div class="flex w-full flex-col gap-8 py-[70px] lg:gap-0">
	...
	<div bind:this={block} class="flex flex-col gap-10 lg:flex-row lg:gap-0">
		...
		<div class="p-6 pt-0 lg:w-2/3 lg:p-20 lg:pl-5">
			<div class="w-full lg:w-4/5">
				<p
					class="text-primary-text text-[20px] leading-[28px] tracking-[-0.2px] lg:text-[24px] lg:leading-[33px] lg:tracking-[-0.5px]"
				>
				...
				<div
					class="text-secondary-text my-6 flex flex-col gap-4 text-base lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
				>
					<p>
				...
				<div class="mt-10 mb-12 flex flex-col gap-4 lg:mt-20">
					<h3 class="text-[24px] leading-[33px] font-semibold tracking-[-1px]">Soft Skills</h3>
					<p
						class="text-secondary-text text-base lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
					>
					...
					<ul class="flex flex-col gap-4">
						<li class="flex gap-3">
							...
							<div class="">
								<span
									class="text-primary-text text-base font-semibold lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
									>Attention to detail</span
								><span class="mr-1">:</span>
								<span
									class="text-secondary-text text-base break-words whitespace-normal lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
								>
						...
						<ul class="flex flex-col gap-3">
							{#each TECH_STACK as { name, url, description }}
								<li class="flex items-center gap-3">
									...
									<a
										href={url}
										class="text-tertiary-text text-base break-words whitespace-normal underline lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
										>{name}</a
									>
									<!-- <p
										class="text-secondary-text text-base break-words whitespace-normal lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
			...
			<div class="my-12 flex flex-col gap-4">
				...
				<p
					class="text-secondary-text w-full text-base lg:w-[90%] lg:text-[18px] lg:leading-[28px] lg:tracking-[-0.2px]"
				>
				...
				<div class="mt-8 flex flex-col gap-4 lg:flex-row">
					<div
						class={`order-2 grid gap-3 transition-all duration-300 lg:grid-cols-2 ${
							selected ? 'w-full lg:w-[600px]' : 'w-full lg:grid-cols-3'
						}`}
					>
					...
					{#if selected}
						<div
							class="flex w-full items-start justify-start rounded-lg p-4 px-0 transition-all duration-300 lg:px-4"
